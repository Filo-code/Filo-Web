      ...
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link href="/prodotti/galatea" className="group flex items-center text-[#B5B5BE] hover:text-white text-sm transition-colors">Galatea <ArrowUpRight className="w-3 h-3 ml-1 opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all" /></Link></li>
            <li><Link href="/prodotti/cricchetto" className="group flex items-center text-[#B5B5BE] hover:text-white text-sm transition-colors">Cricchetto <ArrowUpRight className="w-3 h-3 ml-1 opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all" /></Link></li>
            <li><Link href="/prodotti/atlas" className="group flex items-center text-[#B5B5BE] hover:text-white text-sm transition-colors">Atlas <ArrowUpRight className="w-3 h-3 ml-1 opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all" /></Link></li>
